...
public:
  ViscousFluidInterpolator()
      : VISCOUS_FLUID_NORMALIZE(1.0f / viscousFluid(1.0f)), VISCOUS_FLUID_OFFSET(1.0f - VISCOUS_FLUID_NORMALIZE * viscousFluid(1.0f)) {
  }
